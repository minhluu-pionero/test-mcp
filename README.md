...
- Hãy tưởng tượng bạn thuê một nhân viên mới. Thay vì mỗi ngày phải giải thích lại cách làm việc, bạn đưa cho họ một cuốn "Sổ tay quy trình" — làm việc gì thì theo quy trình đó.
- Prompts được định nghĩa và lưu trữ ngay bên trong MCP Server.
```
Ví dụ
Không có Prompts
